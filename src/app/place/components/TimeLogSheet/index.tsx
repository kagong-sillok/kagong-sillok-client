...
import { usePostRecord } from '@/apis/record';
import { useGetUserInfo } from '@/apis/user';
import { Button, ImageUpload, BottomSheet, Spacing, Modal } from '@/components';
...
export default function TimeLogSheet({ isOpen, placeId, onClose }: TimeLogSheetProps) {
    ...
    <>
      ...
      >
        <div className="h-full px-6 pb-20 pt-8">
          ...
          <Spacing size={24} />
          <p className="text-center text-body2 text-bk60">카공을 얼마나 했나요?</p>
          <Spacing size={16} />
          ...
          <hr className="text-bk10" />
          <Spacing size={24} />
          <p className="text-center text-body2 text-bk60">어떤걸 했나요?</p>
          <Spacing size={16} />
          <input
            type="text"
